...
class EngineWrapper:
    ...
    def search(self, board: chess.Board, time_limit: chess.engine.Limit, ponder: bool, draw_offered: bool,
        ...
        :return: The move to play.
        """
        # Override any existing settings to always use 'go nodes 1'
        # This will cause the engine to use its neural network evaluation directly
        # without any search, which is ideal for Maia networks
        time_limit = chess.engine.Limit(nodes=1)
        logger.info(f"Using 'go nodes 1' for move generation with Maia network")
